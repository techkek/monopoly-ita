    ...
    render() {
        if (this.props.game) {
            ...
            return (<div className="board-container">
                ...
                <div className="imprevisti-stack card-stack" onClick={() => gameService.drawCard('imprevisti')}>
                    <span>Imprevisti</span>
                    <div className="icon">
                ...
                <div className="board">
                    ...
                    <Imprevisti position="7" boardPos="bottom"/>
                    ...
                    <Imprevisti position="22" boardPos="top"/>
                    ...
                    <Imprevisti position="36" boardPos="right"/>
