            ...
            return (<div>
                ...
                {card && <div className="card-overlay">
                    <div className={"card-picked " + card.type}>
                        ...
                        <span className="card-player">La carta va a: {card.player.name}</span>
                    </div>
                </div>}
            </div>);
        } else {
            return (<div className="game-loading">
                {this.state.lostConnection && <span>Connessione al server persa, riconnessione...</span>}
                {!this.state.lostConnection && <span>Caricamento...</span>}
            </div>);
        }
    }
